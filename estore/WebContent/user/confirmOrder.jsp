...
<table cellspacing=1 cellpadding=3 align=center class=tableBorder2>
	<tr>
		<td height=25 valign=middle><img src="../images/Forum_nav.gif"
			...
			border="0" src="../images/dog.gif" width="19" height="18"> 确认定单
		</td>
	</tr>
</table>
<br>
...
<table cellpadding="3" cellspacing="1" align="center"
	...
	<tr>
		<td valign="middle" colspan="2" align="center" height="25"
			...
			onclick="javascript:window.location='../UserInfoServlet';"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tablebody1">${customer.address.city }</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tablebody1">${customer.telephone.homeTel }</td>
	</tr>
	<tr>
		<td class="tablebody2" align="right"><b>办公室电话</b>：</td>
		<td class="tablebody1">${customer.telephone.officeTel }</td>
	</tr>
	<tr>
		<td class="tablebody2" align="right"><b>手机</b>：</td>
		<td class="tablebody1">${customer.telephone.mobile }</td>
	</tr>
	<tr>
...
<table cellpadding="3" cellspacing="1" align="center"
	...
	<tr>
		...
		<select name="payway">
				...
				<option value="邮局汇款" checked>邮局汇款</option>
...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1
	...
	<tr>
		<td valign=middle align=center height=25
			background="../images/bg2.gif" colspan="5"><font color="#ffffff"><b>商品购物清单</b></font><input
			type="button" value="修改"
			onclick="javascript:window.location='../ShowCarServlet';"></td>
	</tr>
...
<p align="center">
	请认真检查以上订单信息，确认无误后，点击 → <a onclick="javascript:document.order.submit();"
		style="cursor: hand"><img src="../images/submit.gif"></a>
</form>
</p>
