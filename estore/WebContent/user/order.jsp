...
<table cellspacing=1 cellpadding=3 align=center class=tableBorder2>
	<tr>
		<td height=25 valign=middle><img src="../images/Forum_nav.gif"
			...
			border="0" src="../images/dog.gif" width="19" height="18"> 订单列表
		</td>
	</tr>
</table>
<br>
...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
	<tr>
		...
		<td valign=middle align=center height=25
			background="../images/bg2.gif" width=""><font color="#ffffff"><b>订单日期</b></font></td>
		<td valign=middle align=center height=25
		...
		<c:if test="${orderList!=null }">
			<tr>
				...
				<td class=tablebody1 valign=middle align=center width=""><input
					...
					onclick="javascript:window.location='../RemoveOrderServlet?orderid=${order.id}';">&nbsp;<input
					type="button" value="明细"
					onclick="javascript:window.location='../OrderDetailServlet?orderid=${order.id}';">
